## object_recognition_ros_visualization (jade) - 0.3.9-0

The packages in the `object_recognition_ros_visualization` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --rosdistro jade object_recognition_ros_visualization` on `Sun, 15 May 2016 23:22:33 -0000`
...
## object_recognition_ros_visualization (indigo) - 0.3.9-0

The packages in the `object_recognition_ros_visualization` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --track indigo --rosdistro indigo object_recognition_ros_visualization` on `Sun, 15 May 2016 23:19:23 -0000`
